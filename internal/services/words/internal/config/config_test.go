...
func TestFromEnv(t *testing.T) {
	...
	t.Setenv("TAGS_CACHE_SIZE", "200")
	t.Setenv("TAGS_MAX_COST", "300")
	...
	assert.Equal(t, int64(200), cfg.TagsCacheSize)
...
func TestFromEnv_Defaults(t *testing.T) {
	...
	assert.Equal(t, int64(10000), cfg.TagsCacheSize)
	assert.Equal(t, int64(1<<30), cfg.TagsMaxCost)
